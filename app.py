...
@app.route("/chatbot")
def home():
    return render_template("covidchatbot.html")
...
@app.route("/traveladvice")
def tadv():
    return render_template("traveladvice.html")
...
@app.route("/effectivevariant")
def evariant():
    return render_template("effectvariant.html")
